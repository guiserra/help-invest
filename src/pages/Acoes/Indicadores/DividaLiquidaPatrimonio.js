    ...
    return (
        <SafeAreaView style={globalStyles.container}>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <Text style={globalStyles.text}>Divida Liquida sobre Patrimonio Liquido</Text>
                ...
                <View style={[globalStyles.cardBoard, globalStyles.shadow]}>
                    <View style={globalStyles.cardContent}>
                        ...
                        <Text style={[globalStyles.content, globalStyles.shadow]}>A
                            <Text style={[globalStyles.contentBold, globalStyles.shadow]}> Divida Liquida sobre Patrimonio Liquido</Text> é um valor composto pela
