            ...
            <ScrollView>
                ...
                <View style={[globalStyles.cardBoard, globalStyles.shadow, { marginTop: 10 }]}>
                    <View style={globalStyles.cardContent}>
                        ...
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   O conceito de
                            <Text style={[globalStyles.contentBold, globalStyles.shadow]}> P/VPA</Text> trata de Preço sobre Valor Patrimonial por Ação. Ou seja, o preço 
                        ...
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   Para entender seu conceito, é preciso compreender outros elementos envolvidos. O primeiro 
                        ...
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   O PL engloba todos os bens da companhia, como imóveis, maquinários, equipamentos, veículos 
                        ...
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   Por fim, o indicador considera o Preço por Ação, que é a cotação das Ações da empresa no 
                ...
                <View style={[globalStyles.cardBoard, globalStyles.shadow, { marginTop: 10 }]}>
                    <View style={globalStyles.cardContent}>
                        ...
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   O <Text style={[globalStyles.contentBold, globalStyles.shadow]}> P/VPA</Text>, mostra quanto os investidores estariam pagando pelo patrimônio 
                        ...
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   Contudo, vale destacar vincular a análise apenas ao valor patrimonial do negócio pode limitar as informações. Algumas empresas 
                        ...
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   Então é importante saber não só como calcular o P/VPA, mas também como interpretá-lo. Desse modo, você saberá utilizar o conceito 
                        no dia a dia para a tomada de decisões nos investimentos.
                        </Text>
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   Caso contrário, a interpretação isolada de resultados pode induzir o investidor a fazer escolhas que não são as mais adequadas.
                        </Text>
                    </View>
                </View>
                ...
                <View style={[globalStyles.cardBoard, globalStyles.shadow, { marginTop: 10 }]}>
                    <View style={globalStyles.cardContent}>
                        ...
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   Para fazer o cálculo do <Text style={[globalStyles.contentBold, globalStyles.shadow]}> P/PVA</Text> é feito obtendo 
                        a relação entre o preço por Ação e o valor patrimonial por Ação.
                        </Text>
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   Assim, o primeiro passo é definir os outros indicadores.
                        </Text>
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   Veja como funciona o cálculo completo:
                        </Text>
                ...
                <View style={[globalStyles.cardBoard, globalStyles.shadow, { marginTop: 10 }]}>
                    <View style={globalStyles.cardContent}>
                        ...
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   Após encontrar o valor do
                        <Text style={[globalStyles.contentBold, globalStyles.shadow]}> P/VPA</Text> em uma Ação ou em um FII, é importante entender como o resultado deve ser interpretado.
                       </Text>
                       <Text style={[globalStyles.content, globalStyles.shadow]}>   Veja a seguir os aspectos gerais:
                       </Text>
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   
                        ...
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   O indicador reflete o momento atual da empresa, sendo que o resultado mais natural é próximo a 1. 
                        ...
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   O dado pode ser utilizado para ajudar na definição do seu investimento. Por exemplo, um resultado 
                ...
                <View style={[globalStyles.cardBoard, globalStyles.shadow, { marginTop: 10 }]}>
                    <View style={globalStyles.cardContent}>
                        ...
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   A aplicação prática do P/VPA na sua carteira dependerá dos seus objetivos com o investimento. 
                        Então não existe uma fórmula exata sobre como utilizar o indicador.
                       </Text>
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   Geralmente, em investimentos de longo prazo ele é um dos fundamentos considerados para definir 
                        ...
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   Para evitar equívocos ou vieses na sua avaliação, o ideal é não considerar apenas o P/VPA. Nesse cenário, é importante entender quais outros indicadores podem ser avaliados.
                        </Text>

                        <Text style={[globalStyles.content, globalStyles.shadow]}>   Veja alguns exemplos:
                        </Text>
                        <Text style={[globalStyles.content, globalStyles.shadow]}>   
