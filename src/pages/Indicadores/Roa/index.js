        ...
        <SafeAreaView style={styles.container}>
            <ScrollView>
                ...
                <View style={[styles.cardBoard, styles.shadow, { marginTop: 10 }]}>
                  ...
                  de rentabilidade de ativos que demonstra o quanto uma empresa é rentável em relação ao seu conjunto de ativos.
                  </Text>
                        <Text style={[styles.content, styles.shadow]}>   Nessa perspectiva, com o
                        <Text style={[styles.contentBold, styles.shadow]}> ROA</Text> é possível analisar a 
