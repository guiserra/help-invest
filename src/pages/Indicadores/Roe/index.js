            ...
            <ScrollView>
                ...
                <View style={[styles.cardBoard, styles.shadow, { marginTop: 10 }]}>
                    <View style={styles.cardContent}>
                        ...
                        <Text style={[styles.content, styles.shadow]}>   Quando um ROE é alto, é possível interpretar que a empresa tem utilizado 
                ...
                <View style={[styles.cardBoard, styles.shadow, { marginTop: 10 }]}>
                    <View style={styles.cardContent}>
                        ...
                        <Text style={[styles.content, styles.shadow]}>
                            <Text style={[styles.title, styles.shadow]}>   ROE = Lucro Líquido / Patrimônio Líquido </Text>
                        </Text>
                    </View>
                </View>
                ...
                <View style={[styles.cardBoard, styles.shadow, { marginTop: 10 }]}>
                    <View style={styles.cardContent}>
                        ...
                        <Text style={[styles.content, styles.shadow]}>   É possível que uma empresa possua uma empresa com um percentual de ROE elevado, mas 
                        tenha dívidas que comprometam a eficiência de suas atividades. Por isso, uma análise completa de indicadores é mais indicada.
                        </Text>
